...
import vip.geekclub.manager.application.command.department.CreateDepartmentCommand;
import vip.geekclub.manager.application.command.department.DeleteDepartmentCommand;
import vip.geekclub.manager.application.command.department.UpdateDepartmentCommand;
import vip.geekclub.manager.application.query.DepartmentInfoQueryService;
import vip.geekclub.manager.application.query.DepartmentTreeQueryService;
import vip.geekclub.manager.application.query.dto.DepartmentInfoResult;
