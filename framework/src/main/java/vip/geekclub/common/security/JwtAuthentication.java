package vip.geekclub.common.security;
...
public class JwtAuthentication implements Authentication {
    ...
    public JwtAuthentication(JwtPrincipal principal, Set<String> permissions) {
    ...
    public String getToken(long expirationSeconds) {
        return jwtPrincipal.getToken(expirationSeconds);
    }
}
