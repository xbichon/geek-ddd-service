 ...
 *
 */
@CommandHandlerMapping(PasswordVerificationCommandHandler.class)
@Builder
public record PasswordVerificationCommand(
    ...
    public PasswordVerificationCommand(String userType, String identifier, String  password){
